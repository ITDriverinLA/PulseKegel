...
var welcomeScreenshot = loadScreenshotBase64("welcome.png");
var workoutScreenshot = loadScreenshotBase64("workout-player.png");
var progressScreenshot = loadScreenshotBase64("progress.png");
...
Rules: exactly 3-4 sentences. No filler phrases like "Great job!", "Keep it up!", or "You're doing amazing!". No medical conditions, surgeries, diagnoses, or health problems. No quotes in the response.`;
  ...
  app2.get("/favicon.png", (_req, res) => {
    const paths = [
      join2(__dirname2, "public", "favicon.png"),
      join2(__dirname2, "..", "server", "public", "favicon.png"),
      join2(process.cwd(), "server", "public", "favicon.png")
    ];
    for (const p of paths) {
      if (existsSync2(p)) {
  ...
  app2.get("/pulsekegel-infographic.jpg", (_req, res) => {
    const paths = [
      join2(__dirname2, "public", "pulsekegel-infographic.jpg"),
      join2(__dirname2, "..", "server", "public", "pulsekegel-infographic.jpg"),
      join2(process.cwd(), "server", "public", "pulsekegel-infographic.jpg")
    ];
    for (const p of paths) {
      if (existsSync2(p)) {
