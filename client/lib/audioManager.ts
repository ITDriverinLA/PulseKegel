...
export type AmbientTrack = 'none' | 'age_weapon_1' | 'age_weapon_2' | 'training_beats' | 'training_kegel' | 'quiet_power_1' | 'quiet_power_2' | 'quiet_power_f1' | 'quiet_power_f2' | 'surrender' | 'on_my_knees' | 'take_me' | 'velvet_tides' | 'rivers_of_surrender' | 'architect_of_surrender';
