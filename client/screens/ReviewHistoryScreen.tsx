      ...
      >
        {reviews.length > 0 ? (
              ...
              return (
                <Animated.View
                  ...
                  entering={FadeInDown.duration(ANIM_DURATION_ENTER).delay(
                    ANIM_DELAY_SHORT + index * ANIM_DELAY_STAGGER_SM,
                  )}
                >
                  <Pressable
                    style={[
                      ...
                      isExpanded && {
                        borderColor: cp.neonPurple + "25",
                        backgroundColor: cp.neonPurple + "04",
                      },
                      ...
                      <View style={styles.cardHeaderLeft}>
                        ...
                        >
                          <Text
                            style={[
                              ...
                              { color: accent, fontSize: 12 * fontScale },
                            ]}
                          >
                            {review.weekNumber === 0
                              ? "T1"
                        ...
                        <View>
                          ...
                          <Text
                            style={[
                              styles.phaseLabel,
                              { color: phase.color, fontSize: 11 * fontScale },
                            ]}
                          >
                            {phase.name}
                          </Text>
                      ...
                      <View style={styles.cardHeaderRight}>
                        <View style={styles.miniStats}>
                          <View style={styles.miniStat}>
                            ...
                            <Text
                              style={[styles.miniStatText, { color: accent }]}
                            >
                      ...
                      >
                        ...
                        <View
                          style={[
                            ...
                            {
                              backgroundColor: cp.neonPurple + "06",
                              borderColor: cp.neonPurple + "12",
                            },
                          ]}
                        >
          ...
          <View style={styles.emptyContainer}>
            ...
            >
              Complete a full week of your program to receive your first AI
              progress review.
            </Text>
          </View>
        )}
