  ...
  return (
    <Animated.View style={fadeStyle}>
      <LinearGradient colors={cp.gradient} style={styles.container}>
        ...
        >
          <Animated.View
            entering={FadeInUp.duration(ANIM_DURATION_CONTENT_SLOW)}
            style={styles.topSection}
          >
            <View
              style={[
                styles.iconCircle,
                { backgroundColor: cp.neonCyan + "22" },
              ]}
            >
              <Text style={[styles.arrowIcon, { color: cp.neonCyan }]}>↑</Text>
            </View>
            <Text style={[styles.appName, { color: cp.textMuted }]}>
              PulseKegel
            </Text>
            ...
            <Text style={[styles.subtitle, { color: cp.textSecondary }]}>
              A new version of PulseKegel is available. Please update to
