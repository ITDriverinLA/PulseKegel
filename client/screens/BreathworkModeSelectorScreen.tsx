            ...
            >
              ...
              >
                ...
                <View style={styles.modeInfo}>
                  <Text
                    style={[styles.modeName, { color: bwColors.phase_label }]}
                  >
                    {mode.name}
                  </Text>
                  <Text
                    style={[styles.modeSubtitle, { color: bwColors.accent }]}
                  >
                    {mode.subtitle}
                  </Text>
                  <Text
